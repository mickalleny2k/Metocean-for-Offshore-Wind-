...
plot_kernel <- ggplot(wave,aes(x=mwd,y=hs)) +xlab("Mean Wave Direction (MWD) (degrees)") +
...
ggsave(plot_kernel, file="output/plots/hs_mwd_kernel_density.jpeg", dpi=600, height=5, width=7, units=c("in"))
